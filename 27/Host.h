...
struct RendererContext {
    std::unique_ptr<Shader> blockShader, skyboxShader, sunMoonShader, starShader, selectionShader;
    GLuint cubeVBO;
...
namespace BlockSelectionSystemLogic { void UpdateBlockSelection(BaseSystem&, std::vector<Entity>&, float, GLFWwindow*); }

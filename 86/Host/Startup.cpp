...
namespace HostLogic {
    void LoadProcedureAssets(BaseSystem& baseSystem, std::vector<Entity>& prototypes, float dt, GLFWwindow* win) {
        ...
        std::vector<std::pair<std::string, std::string>> shaderFiles = {
            ...
            {"COLOR_EMOTION_VERTEX_SHADER", "Procedures/Shaders/ColorEmotion.vert.glsl"},
            {"COLOR_EMOTION_FRAGMENT_SHADER", "Procedures/Shaders/ColorEmotion.frag.glsl"},
            ...
            {"GLYPH_VERTEX_SHADER", "Procedures/Shaders/Glyph.vert.glsl"},
            {"GLYPH_FRAGMENT_SHADER", "Procedures/Shaders/Glyph.frag.glsl"},

...
void main(){
    ...
    bool isFishingMode = buildModeType == 4;
    ...
    if (isBuildMode) {
        ...
        vec3 fillStart = isDestroyMode ? vec3(0.0, 1.0, 1.0) : (isFishingMode ? vec3(0.0, 0.9, 1.0) : vec3(0.1, 0.8, 0.2));
        vec3 fillEnd = isDestroyMode ? vec3(1.0, 0.0, 1.0) : (isFishingMode ? vec3(1.0, 0.52, 0.0) : vec3(1.0, 0.5, 0.0));

...
private:
    void init() {
        ...
        initializeBlockColors(); // Initialize the global color array
        ...
        if (worldEntity && starProto) {
            ...
            for (int i = 0; i < NUM_BLOCK_PROTOTYPES; ++i) {
                ...
                worldEntity->instances.push_back(instanceSystem.createInstance(i, pos));
            }
            for (int i = 0; i < NUM_STARS; i++) {
                ...
                worldEntity->instances.push_back(instanceSystem.createInstance(starProto->prototypeID, pos));
            }
        }

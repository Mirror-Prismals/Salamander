...
struct ChunkContext {
    ...
    std::unordered_map<glm::ivec3, ChunkData, ChunkIVec3Hash> chunks;
    std::unordered_set<glm::ivec3, ChunkIVec3Hash> dirtyChunks;
    std::unordered_map<glm::ivec3, ChunkRenderBuffers, ChunkIVec3Hash> renderBuffers;
    std::unordered_set<glm::ivec3, ChunkIVec3Hash> renderBuffersDirty;
...
struct FaceContext {
    std::unordered_map<glm::ivec3, FaceChunkData, ChunkIVec3Hash> faces;
    std::unordered_set<glm::ivec3, ChunkIVec3Hash> dirtyChunks;
    bool initialized = false;
};
...
namespace ChunkSystemLogic { void UpdateChunks(BaseSystem&, std::vector<Entity>&, float, GLFWwindow*); void MarkChunkDirty(BaseSystem&, const glm::vec3&); }
namespace FaceCullingSystemLogic { void UpdateFaces(BaseSystem&, std::vector<Entity>&, float, GLFWwindow*); void MarkChunkDirty(BaseSystem&, const glm::ivec3&); }

    ...
    void init() {
        ...
        // --- STEP 4: Create Prototypes and Instances ---
        {
            ...
            const std::vector<std::string> entityFiles = {
                ...
                "Entities/Water.json",
                "Entities/Stone.json",
                "Entities/Block_3.json",
                "Entities/Block_4.json",
                "Entities/Block_5.json",
                "Entities/Block_6.json",
                "Entities/Block_7.json",
                "Entities/Block_8.json",
                "Entities/Block_9.json",
                "Entities/Block_10.json",
                "Entities/Block_11.json",
                "Entities/Block_12.json",
                "Entities/Block_13.json",
                "Entities/Block_14.json",
                "Entities/Block_15.json",
                "Entities/Block_16.json",
                "Entities/Block_17.json",
                "Entities/Block_18.json",
                "Entities/Block_19.json",
                "Entities/Block_20.json",
                "Entities/Block_21.json",
                "Entities/Block_22.json",
                "Entities/Block_23.json",
                "Entities/Block_24.json"
            }; 

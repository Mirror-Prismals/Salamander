...
struct PlayerContext {
    ...
    int prismalMapMode = 0; // 0 hidden, 1 minimap, 2 fullscreen
    float prismalMapZoom = 3.0f;
...
struct RendererContext {
    ...
    RenderHandle isometricMapCachedTexture = 0;
    int isometricMapCachedWidth = 0;
    int isometricMapCachedHeight = 0;
    RenderHandle topDownMapTexture = 0;
    int topDownMapTextureWidth = 0;
    int topDownMapTextureHeight = 0;
    RenderHandle prismalMapTexture = 0;
    int prismalMapTextureWidth = 0;
    int prismalMapTextureHeight = 0;
    glm::vec2 prismalMapLastCenterXz = glm::vec2(0.0f);
    float prismalMapLastHalfExtent = 0.0f;
    double prismalMapLastBuildTime = -1000.0;
    double prismalMapLastBuildDuration = 0.0;
};
...
namespace VoxelMeshingSystemLogic { void UpdateVoxelMeshing(BaseSystem&, std::vector<Entity>&, float, PlatformWindowHandle); void StopGreedyAsync(); size_t GetGreedyInFlightCount(); size_t GetGreedyQueueCount(); void GetGreedyStats(size_t& queued, size_t& applied, size_t& dropped); }
...
namespace TerrainSystemLogic { void GenerateTerrain(BaseSystem&, std::vector<Entity>&, float, PlatformWindowHandle); }
...
namespace IsometricMapSystemLogic { void UpdateIsometricMap(BaseSystem&, std::vector<Entity>&, float, PlatformWindowHandle); }

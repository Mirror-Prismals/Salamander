...
struct DawContext {
    ...
    std::vector<std::vector<float>> clipAudio;
...
namespace MidiTransportSystemLogic { void UpdateMidiTransport(BaseSystem&, std::vector<Entity>&, float, GLFWwindow*); }
...
namespace DawClipSystemLogic { void UpdateDawClips(BaseSystem&, std::vector<Entity>&, float, GLFWwindow*); }
...
namespace DawIOSystemLogic { void UpdateDawIO(BaseSystem&, std::vector<Entity>&, float, GLFWwindow*); }

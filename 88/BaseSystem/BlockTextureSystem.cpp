...
namespace BlockTextureSystemLogic {
    namespace {
        ...
        void overrideAtlasTilePixels(GLuint atlasTexture,
                                     int tileIndex,
            ...
            glTexSubImage2D(GL_TEXTURE_2D, 0, tileX, tileY, tileSize.x, tileSize.y, GL_RGBA, GL_UNSIGNED_BYTE, rgbaPixels);
        }
        ...
        void overrideAtlasTile(GLuint atlasTexture,
            ...
            overrideAtlasTilePixels(atlasTexture, tileIndex, tileSize, tilesPerRow, tilesPerCol, uploadPixels);

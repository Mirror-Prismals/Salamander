...
namespace GroundCraftingSystemLogic { void RenderGroundCrafting(BaseSystem& baseSystem, std::vector<Entity>& prototypes, float dt, GLFWwindow* win); }
...
namespace BlockChargeSystemLogic { void RenderBlockDamage(BaseSystem& baseSystem, std::vector<Entity>& prototypes, float dt, GLFWwindow* win); }
